...
export default function Categories() {
  ...
  const filteredCategories = useMemo(() => {
    ...
    return categories
      .filter((category) => category.name?.toLowerCase().includes(query) || category.description?.toLowerCase().includes(query))
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Icon name="list-outline" size={52} color={theme.colors.border} />
